    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-dark-50 mb-2">Loading Questionnaire</h2>
          <p className="text-dark-300">Please wait while we prepare your personalized questions...</p>
        </div>
      </div>
    }>
